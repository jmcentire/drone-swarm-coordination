...
[0065] The inventor's prior published research artifacts include "Decentralized Drone Swarm Coordination via Broadcast-as-Shared-State and Hierarchical PCA-Tree Bisection" (paper, May 2026), available in the v1.4 static paper archive at <https://doi.org/10.5281/zenodo.20615823>, together with the associated v1.4 software archive at <https://doi.org/10.5281/zenodo.20615824> and the corresponding source repository at <https://github.com/jmcentire/drone-swarm-coordination>. These artifacts describe substantially the same invention with empirical validation across $N = 10$ to $N = 10$,000 agents and formal proofs including a slot-disjointness composition lemma, a three-part inter-layer composition theorem, and a rigorous $O(1/\sqrt{N})$ bound on the rounding contribution to optimality gap.
